...
create table if not exists public.offers (
  ...
  preco_atual numeric,
  preco_pix numeric,
  oferece_parcelamento boolean not null default false,
  parcelas integer,
  valor_parcela numeric,
  parcelamento_sem_juros boolean not null default false,
  cupom text,
...
-- ============================================================
-- ANALYTICS DO SITE
-- Para projetos já existentes, rode supabase/analytics.sql uma vez.
-- ============================================================
