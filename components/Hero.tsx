    ...
    <section className="site-shell py-8 md:py-14">
      <div className="relative overflow-hidden rounded-3xl border border-[#f5b942]/25 bg-gradient-to-br from-[#102b48] via-[#0b1a2d] to-[#07111f] px-6 py-10 shadow-2xl md:px-12 md:py-16">
        <div className="relative z-10 max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-sm text-slate-200"><span className="rounded-full border border-[#f5b942]/30 px-4 py-2">✓ Ofertas conferidas</span><span className="rounded-full border border-[#f5b942]/30 px-4 py-2">⌑ Cupons exclusivos</span><span className="rounded-full border border-[#f5b942]/30 px-4 py-2">⚡ Economia real</span></div>
        </div>
      </div>
    </section>
  );
